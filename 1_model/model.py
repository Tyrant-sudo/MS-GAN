...
class generate_process():
    ...
    def get_variation(self,generator):
...
class process2():
    ...
    def sample(self,base_mesh,batch_size,test_path = 'result/test_pic',draw = True):
...
class DeepConvNet(nn.Module):
    ...
    def forward(self, x):
        ...
        out1 = self.conv5(x).view(-1,self.out_point,2)*0.1
