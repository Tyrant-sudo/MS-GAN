...
def draw_ffd(foil_data,name,path):
    ...
    para,point = deform.get_ffd(_,dim)
...
def get_value_center(data):
    ...
    try:
        ...
        return is_inter,is_watertight,-1,-1
    return is_inter,is_watertight,volume,center

def get_value_center_poisson(data):
...
def draw_multi_tsne_distribution(g1 ,g1_space = 8,g2_space = 1, *args):
    ...
    color_bar = ['salmon','mediumpurple','lime','deeppink','darkorange','paleturquoise']
    c = -1
